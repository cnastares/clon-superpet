...
function CabeceraInfo() {
  return (
    <div>
      ...
      <h1>Al cuidar de tu mascota puedes mejorar tu salud física y mental</h1>
      <p>¿Sabías que la hormona Oxitocina, que se secreta cuando el cuerpo experimenta placer, 
        también se secreta cuando una mascota y su dueño experimentan interacciones positivas entre si?</p>
      ...
      <p>Se encuentra comprobado que al tener una estrecha relación con tu mascota e interactuar con esta regularmente, aparecen una serie de beneficios en tu vida. Por ejemplo, acariciar a una mascota por aproximadamente 10 minutos o más puede aliviar rápidamente el estrés cotidiano y bajar tu presión arterial. 
        La compañía de tu mascota también puede mejorar tu salud mental al evitar depresiones. </p>
        <p>Estudios demuestran que las personas que cuidan de sus mascotas también podrían ser más saludables, a razón que al sacarlos a caminar o correr y también jugar activamente con ellos se hace ejercicio teniendo un impacto positivo en su cuerpo y mente. 
          En particular se han demostrado beneficios de salud al disminuir la tasa de problemas cardiovasculares. </p>
          <p>Muy específicamente los perros también pueden ayudar a las personas con ciertos problemas de salud como la epilepsia y el cáncer, ya que ciertos perros se pueden entrenar a detectar estos problemas antes de que ocurran o justo en el momento en el cuál se está comenzando.</p>
        <h2>A continuación te listamos una serie de beneficios que podría traer el cuidar de tus perros: </h2>
        <ul>
        ...
        <h2>Cuidados médicos esenciales para proteger a tu mascota</h2>
        ...
        <p>Al igual que un niño, tus mascotas necesitan de cuidados médicos desde sus primeras semanas de vida. De lo contrario pueden llegar a contagiarse de posibles parásitos y enfermedades que consecuentemente pueden llegar a enfermar a tu familia.  
            ...
            <Imgs className="imagen-cabecera" /> {/* Usa el componente Imgs para mostrar las imágenes */}
    </div>
  );
}
